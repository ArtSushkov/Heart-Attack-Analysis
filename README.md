...
- **Инициализация препроцессора**: Проверка загрузки артефактов и конфигурации
- **Проверка обязательных признаков**: Тестирование реакции на отсутствие необходимых фичей
- **Обработка категориальных признаков**: Проверка кодирования и обработки пропусков
- **Обработка числовых признаков**: Тестирование масштабирования
- **Обработка пропущенных значений**: Проверка импьютинга и удаления строк
- **Параметризованное тестирование кодирования**: Проверка разных форматов значений признаков
- **Преобразование типов данных**: Контроль корректности типов после обработки
- **Дымовой тест**: Базовая проверка работоспособности
- **Тест производительности**: Обработка больших объемов данных (1000 записей)
